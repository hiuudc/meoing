/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.api.jsonc --env-file=.dev.vars.example --env-interface=ApiEnv` (hash: 87a12bdab2054fd1651bab57e6d6f44f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "CORS_ORIGINS" | "SUPABASE_URL" | "SUPABASE_JWT_AUDIENCE" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME" | "PRESIGNED_UPLOAD_TTL_SECONDS" | "PRESIGNED_DOWNLOAD_TTL_SECONDS" | "OPENAI_MODEL" | "OPENAI_DAILY_BUDGET_UNITS" | "OPENAI_LESSON_RESERVATION_UNITS" | "OPENAI_ASSISTANCE_RESERVATION_UNITS" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "INVITE_TOKEN_SECRET" | "TURNSTILE_SECRET_KEY" | "OPENAI_API_KEY">> {}
}
