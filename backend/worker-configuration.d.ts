/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.api.jsonc --env-file=.dev.vars.example --env-interface=ApiEnv` (hash: f2c40d768d4952df29198b808ddfd302)
