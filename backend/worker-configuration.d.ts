/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.api.jsonc --env-file=.dev.vars.example --env-interface=ApiEnv` (hash: 56b3e4d476ec7397ddf6262d2c9e9678)
...
interface __BaseEnv_ApiEnv {
	...
	PROGRESS_RATE_LIMIT: RateLimit;
	APP_ENV: "staging" | "production" | "local";
	CORS_ORIGINS: "https://staging.meoing.com" | "https://meoing.com" | "http://127.0.0.1:5173,http://localhost:5173";
	...
	R2_ACCOUNT_ID: "29e80074abc5eb106165d2349db7ca56" | "REPLACE_WITH_ACCOUNT_ID";
	R2_BUCKET_NAME: "meoing-files-staging" | "meoing-files-production" | "meoing-files-local";
...
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/api-worker");
	}
	interface StagingEnv {
		...
		SUPABASE_JWT_AUDIENCE: "authenticated";
		R2_ACCOUNT_ID: "29e80074abc5eb106165d2349db7ca56";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "CORS_ORIGINS" | "SUPABASE_URL" | "SUPABASE_JWT_AUDIENCE" | "R2_ACCOUNT_ID" | "R2_BUCKET_NAME" | "PRESIGNED_UPLOAD_TTL_SECONDS" | "PRESIGNED_DOWNLOAD_TTL_SECONDS" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "INVITE_TOKEN_SECRET" | "TURNSTILE_SECRET_KEY">> {}
}
